...
当前进入 **M1 TS3 连接与频道切换实验**。桌面版可双击服务器书签连接或切换服务器，使用 macOS 钥匙串记住密码；频道树显示已同步的可见成员，支持长列表滚动、无密码频道切换和主动断开。连接成功、当前频道成员进出和自身断开有本地提示音，保留独立的本地预览。真实文字发送、密码频道、语音通话和第三方插件尚未开放，不能替代日用 TS3 客户端。
